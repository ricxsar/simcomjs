...
Modem.prototype.dataReceived = function(data) {
  ...
  datas.forEach(function(data) {*/
    ...
    if(delimiter === 'OK' || delimiter.match(/error/i) || delimiter === '>' || delimiter == item.escape_char || item.escape_func(delimiter) ||  item.escape_regexp.test(delimiter)) { //Command finished running.
